    ...
    def get_prompt(self, history: Optional[DescriptionHistory] = None) -> ChatPromptTemplate:
        ...
        return ChatPromptTemplate.from_messages([
            ("system", 
                ...
                Imagine you are a guide with the personality of a Gen Alpha influencer so use modern slang, but DO NOT CURSE WHAT SO EVER, you are to take in an image and describe the contents to a blind person, 
...
# -----------------------------------------------------------------------------
# Expose the WSGI app for Gunicorn
# -----------------------------------------------------------------------------
